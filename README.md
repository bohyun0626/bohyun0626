...
## 🖥️ Projects
#### 📌 프로젝트명: 온라인 쇼핑몰 고객 이탈 분석
#### 기간: 2024.09 ~ 2024.10
#### 사용 기술: Python, Pandas, Logistic Regression
#### 역할: 데이터 전처리, 이탈 예측 모델 개발
#### 주요 내용:
#### 약 1만 명의 고객 행동 데이터를 수집, 전처리 (Null/Outlier 처리)
이탈 여부를 타겟으로 분류 모델 개발 → Accuracy 83%, F1-score 0.76 달성
상관관계 분석 및 고객군 시각화로 인사이트 도출
#### 성과:
#### 이탈률 높은 고객 특성(최근 2주 미구매 + 낮은 리뷰 점수) 도출
