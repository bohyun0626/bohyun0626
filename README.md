...
**💼 주요 업무**
- ERP DB 내 품목 및 작업지시 내역의 저장, 조회, 삭제 내역을 주기적으로 추출하는 SP 로직 개발
- MES와의 데이터 정기 동기화 로직 구현
- SP 호출 스케줄링 설계 및 로그 기반 안정성 테스트
- MES 시스템 담당자와 연동 정상 작동 검증

**✅ 성과**
- ERP ↔ MES 데이터 일치율 100% 확보
- 실시간 MES 데이터 조회 환경 구축
- 향후 자동화 확장의 기반 마련
